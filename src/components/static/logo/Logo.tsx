export default function Logo() {
	return (
		<span className="flex justify-center items-center gap-1">
				...
				>
					<defs>
						<linearGradient
							...
							id="color-1_PvvcWRWxRKSR_gr1"
						>
							<stop offset="0" stopColor="#0000fb"></stop>
							<stop offset="0.995" stopColor="#bc00e1"></stop>
						</linearGradient>
						<linearGradient
							x1="7.635"
							y1="32.87"
					...
					>
						<g transform="scale(5.33333,5.33333)">
							...
							<path
								...
								fill="url(#color-1_PvvcWRWxRKSR_gr1)"
							></path>
							<path
								...
								fill="url(#color-2_PvvcWRWxRKSR_gr2)"
							></path>
							<path
            ...
            {/* text */}
			<span className="capitalize font-bold text-white">meta code</span>
		</span>
	);
}
