...
export default function Footer() {
	return (
    <div>
		<div className="min-h-40 overflow-hidden bg-[url(/imgs/foter_back.jpg)] bg-center bg-no-repeat bg-cover mt-20">
			<div className="size-full h-full min-h-40 bg-gradient-to-r from-black/35 to-black/90 p-8">
				<div className="resp relative z-30 grid grid-cols-2 max-md:grid-cols-1 gap-5 gap-y-10 justify-items-end items-center h-full">
					...
					<div className="max-w-[450px] max-md:text-center *:max-md:text-center max-md:w-full max-md:mx-auto space-y-4 text-start max-md:order-1" dir="rtl">
